        ...
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20">
            ...
            <form>
                <div>
                    ...
                    <input className="w-full input input-bordered h-10" id="username" type="text" placeholder="Enter username" />
                </div>
                ...
                <div>
                    ...
                    <input className="w-full input input-bordered h-10" id="password" type="password" placeholder="Enter password" />
                </div>
